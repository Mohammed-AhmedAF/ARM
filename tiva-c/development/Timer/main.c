...
/*Enabling clock for peripherals*/
	...
	SYSCNTRL_vidEnableTimerClock(SYSCNTRL_TIMER_3);
	...
	timer0AConfig.u8TimerID = TIMERS_TIMER_3;
	timer0AConfig.u8TimerBlock = TIMERS_BLOCK_A;
	...
	/*NVIC configuration*/
	NVIC_vidSetInterrupt(NVIC_TIMER3A);
